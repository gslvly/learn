...
// let arrybuffer1 = base64to2(localStorage.base64)
// let arrybuffer = base64to2(localStorage.base64)
// let arrybuffer = decode(localStorage.base64)
// let blob = new Blob([arrybuffer], { type: 'image/png' })
let blob = dataURLtoBlob(localStorage.base64)
